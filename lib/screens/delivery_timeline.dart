...
import 'package:carrierbuddie/widgets/delivery_card.dart';
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            const DeliveryStageCard(title: "Delivery Requested"),
            const MySeperator(),
            const DeliveryStageCard(title: "Delivery Request Accepted"),
            const MySeperator(),
            const DeliveryStageCard(title: "Seller & Peer Consensus"),
            const MySeperator(),
            Column(
